...
**Du bist hier:** Teil A · Vorbereitung (Start von Paket A1)  
...
|---|---|---|---|
| [A1](a1-setup-build.md) | **Projekt-Setup & Build-Pipeline:** Vite, TypeScript und Asset-Pipeline für 102 Kartenbilder einrichten. | ⏳ bereit | 🤖 Claude |
| [A2](a2-core-engine.md) | **Core Engine & Datenmodelle:** Deterministische State Machine, Kartendatenbank und Regel-Unit-Tests erstellen. | ⏳ offen | 🤖 Claude |
